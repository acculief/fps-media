---
title: "『ゼンゼロ』千夏（Sunna）おすすめビルドガイド──ドライバディスク・ドライバディスク・W-エンジン・凸効果を徹底解説"
description: "ゼンレスゾーンゼロ Ver.2.6で実装されたS級サポート「千夏」の最適ビルドを解説。おすすめドライバディスクセット、W-エンジン、ステータスの優先度、凸ごとの性能変化をまとめる。"
category: "character"
...
| セット | 効果 |
|---|---|
| **シャオルン・レコード 4pc** | 連携スキルまたはアルティメット使用時、チーム全員のATK+12%（15秒）。サポートの定番セット |
...
千夏は**「ATKを盛るだけで仕事をする」**シンプルかつ強力なサポート。ビルドの方向性が明確で、初心者でも組みやすい。ATK3,500のラインを意識してドライバディスクを厳選しよう。
