...
{{千夏}}はVer.2.5で実装された**{{葉瞬光}}**との相性が極めて良好。エーテルヴェール関連のシナジーが強力で、メタの中心になりうるサポートエージェントだ。
...
- **属性/専門**: エーテル・異常
- **チャージ攻撃特化**: EXスキルで**「ファンダムパワー」**（ペン{{ライト}}型リソース）を生成し、チャージ攻撃を強化
