...
const ICONS = {
  ...
  "Agent_Alexandrina_Sebastiane_Icon.png": "rina.png",
  ...
  "Agent_Nangong_Yu_Icon.png": "nangong-yu.png",
  "Agent_Sunna_Icon.png": "chinatsu.png",
  ...
  "Agent_Luciana_de_Montefio_Icon.png": "lucy.png",
